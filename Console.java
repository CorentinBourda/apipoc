...
public class Console {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String mapboxUrl = String.format("https://api.mapbox.com/directions-matrix/v1/mapbox/walking/%s?sources=0&annotations=distance,duration&access_token=%s",gps_positions,oc_token);
    ...
    System.out.println(hash);
    System.out.println(hash.getJsonArray("distances"));
  }
